...
["Assume you have 90 seconds with a new user before they decide to use your app or delete it.","Tamara Steffens"],
...
["Don't be cocky. Don't be flashy. There's always someone better than you.","Tony Hsieh, Zappos.com"],
...
["Building and hanging on to an audience is the biggest role of social media.","Matthew Inman"],
...
["A poorly implemented feature hurts more than not having it at all.","Noah Everett"],
...
["It takes humility to realize that we don't know everything, not to rest on our laurels and know that we must keep learning and observing. If we don't, we can be sure some startup will be there to take our place.","Cher Wang"],
["There's an entrepreneur right now, scared to death, making excuses, saying, 'It's not the right time just yet.' There's no such thing as a good time. Get out of your garage and go take a chance, and start your business.","Kevin Plank"],
...
["You have a viable business only if your product is either better or cheaper than the alternatives. If it's not one or the other, you might make some money at first, but it's not a sustainable business.","Jim Koch"],
["Every time I took these bigger risks, the opportunity for a bigger payout was always there.","Casey Neistat"],
["If you can do something to get somebody excited — not everybody — but if you can be the best for somebody, then you can win.","Ron Shaich"],
